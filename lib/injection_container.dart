...
import 'package:one_news/feature/daily_news/data/data_sources/local/app_database.dart';
import 'package:one_news/feature/daily_news/data/data_sources/remote/news_api_service.dart';
import 'package:dio/dio.dart';
import 'package:one_news/feature/daily_news/data/repository/article_repository_impl.dart';
...
import 'package:one_news/feature/daily_news/presentation/bloc/article/local/local_article_bloc.dart';
...
Future<void> initializeDependencies() async {
  ...
  final articles = await database.articleDAO.getArticles();
  print(articles);
  // Dio
